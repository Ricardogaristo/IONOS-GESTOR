...
MYSQL_CONFIG = {
    ...
    'user':               os.getenv('MYSQL_USER', 'ricardogaristo'),
    'password':           os.getenv('MYSQL_PASSWORD', ''),
    'database':           os.getenv('MYSQL_DB', 'gestor_tareas'),
    'charset':            'utf8mb4',
    'autocommit':         False,
...
def get_form_conn() -> MysqlConnectionWrapper:
    ...
    _CONNECT_KEYS = {"host", "port", "user", "password", "database",
                     "charset", "autocommit", "connection_timeout"}
